...
**Purpose:** Enable rich, personality-driven voice delivery across all PAI agents using emotional intelligence markers and markdown prosody.
...
### Enthusiasts (PAI, Intern, Pentester, Artist)
...
curl -X POST http://localhost:8888/notify \
  ...
  -d '{"message":"[💥 excited] Found the **actual** bug!","voice_id":"your-voice-id-here","title":"PAI"}'

# Test markdown prosody
curl -X POST http://localhost:8888/notify \
  -H "Content-Type: application/json" \
  -d '{"message":"Wait... I found something **critical**!","voice_id":"your-voice-id-here","title":"PAI"}'

# Test combined
curl -X POST http://localhost:8888/notify \
  -H "Content-Type: application/json" \
  -d '{"message":"[✨ success] Deployment **complete** -- all systems operational!","voice_id":"your-voice-id-here","title":"PAI"}'
```
