...
const DEFAULT_CONFIG: SecurityConfig = {
  ...
  allowedCommands: [
    ...
    "file",        // File document with naming + Dropbox sync (preferred)
    "archive",     // Deprecated alias for /file
    "query",       // Search vault
    "help",        // Show help
    ...
    // Naming commands
    "name",        // Set custom name for note or archive file

    // Diagnostic commands
    "verbose",     // Enable verbose tag processing output
  ],
