 ...
 * This is the Conduit half of what PR #1650 got wrong by routing launchd's
 * jobs through Pulse cron. Here launchd keeps owning the job on darwin and
 * systemd owns it on linux, so no install ever has two schedulers for one job.
