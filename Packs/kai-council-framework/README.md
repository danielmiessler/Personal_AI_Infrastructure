...
### Agents
Specialist personas with defined expertise, personality, and decision-making frameworks. Agents are loaded from agent packs (e.g., `kai-agents-engineering`).
...
- **Agent Packs** (`kai-agents-*`): Provides specialist agents
