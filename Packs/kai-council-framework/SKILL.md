...
```typescript
import { selectAgents } from 'kai-council-framework/Engine/RosterSelector';
...
```typescript
import { synthesize } from 'kai-council-framework/Engine/SynthesisEngine';
...
```typescript
// Looks for agents in Packs/kai-agents-*/
...
```typescript
import { registerAdapter } from 'kai-council-framework/Engine/Orchestrator';
...
- `kai-security-tools`: Automated security scanning during security reviews
- `kai-security-skill`: CMMC compliance knowledge base for Daniel agent
- `kai-joplin-skill`: Record council decisions to Joplin notes

## Security Integration

When `kai-security-tools` is installed, security-focused council sessions can leverage automated scanning:
...
- `kai-devsecops-agents`: DevSecOps team agents (Daniel, Mary, Clay, etc.)
- `kai-security-tools`: Automated security scanning tools
- `kai-security-skill`: Security workflows and CMMC knowledge
- `kai-joplin-skill`: Record decisions to Joplin
