...
Feature: Password Reset
  ...
  - Support Cost Savings: $3,200/month (160 tickets x $20/ticket)
...
BAD: "I think users want dark mode" (assumption)
GOOD: "User research shows 5% want dark mode. Let's defer." (data-driven)

### 2. Vague Acceptance Criteria
BAD: "User can update profile" (vague)
GOOD: "User can update email, name, avatar (not password). Email validation required." (specific)

### 3. Ignoring Business Value
BAD: "Let's build the coolest feature" (tech-driven)
GOOD: "Let's build the feature with highest ROI" (business-driven)

### 4. Over-Promising to Stakeholders
BAD: "We'll deliver everything by next month" (unrealistic)
GOOD: "We'll deliver Must Haves by next month, Should Haves by month +1" (realistic)
