...
This skill provides user-facing tools and workflows for observability operations. It uses the kai-observability-core interfaces and can work with any configured adapter (Prometheus, mock, etc.).
...
The skill uses the observability domain configuration from `providers.yaml`. See kai-observability-core for configuration options.
