...
This skill provides workflows and CLI tools for retrieving secrets from various backends. It uses kai-secrets-core for the provider abstraction and supports multiple adapters.
