...
- `runCouncil()` from kai-council-framework/Engine/Orchestrator
...
- `kai-council-framework`: Core orchestration engine
- `kai-devsecops-agents`: Default agent pack
- `kai-joplin-skill`: For Joplin output integration