...
This adapter implements the `NetworkProvider` interface from `kai-network-core` for UniFi controllers, supporting both UniFi OS (UDM, UDM Pro, UDR) and classic UniFi controllers.

## Installation

```bash
bun add kai-unifi-adapter
```
