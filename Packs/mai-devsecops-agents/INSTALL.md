...
Complete installation instructions for the mai-devsecops-agents pack.
...
cd /path/to/mai-devsecops-agents
...
```bash
cd $PAI_DIR
git submodule add <repo-url> packs/mai-devsecops-agents
ln -s packs/mai-devsecops-agents/Agents skills/Council/agents/devsecops
```
