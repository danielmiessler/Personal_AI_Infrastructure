...
Joplin issues adapter - use Joplin todo notes as an issue tracker. This adapter implements the IssuesProvider interface from mai-issues-core using Joplin's REST API.
...
```bash
bun add mai-joplin-issues-adapter
```

## Usage

```typescript
import JoplinIssuesAdapter from 'mai-joplin-issues-adapter';
...
- [mai-joplin-skill](../mai-joplin-skill) - Full Joplin skill with CLI tools
