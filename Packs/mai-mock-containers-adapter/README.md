...
```bash
bun add mai-mock-containers-adapter
```

## Usage

```typescript
import { MockPlatformAdapter } from 'mai-mock-containers-adapter';
...
- [mai-containers-core](../mai-containers-core) - Core interfaces
- [mai-docker-adapter](../mai-docker-adapter) - Docker adapter
- [mai-k8s-adapter](../mai-k8s-adapter) - Kubernetes adapter
- [mai-containers-skill](../mai-containers-skill) - User-facing workflows
