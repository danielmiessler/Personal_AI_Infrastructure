...
```typescript
import { getNetworkProviderWithFallback } from 'mai-network-core';
...
```typescript
import { listAvailableAdapters } from 'mai-network-core';
...
See [mai-unifi-adapter](../mai-unifi-adapter) or [mai-mock-network-adapter](../mai-mock-network-adapter) for examples.
