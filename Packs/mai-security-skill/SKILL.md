---
name: Security
description: Shift-left security with threat modeling, OWASP analysis, and CMMC compliance. USE WHEN threat model, security review, CMMC, compliance, OWASP, vulnerability analysis. Depends on mai-security-tools for scanning.
depends_on:
  - mai-security-tools
---
...
This skill depends on **mai-security-tools** for automated scanning:
...
1. Runs mai-security-tools DependencyAudit
2. Runs mai-security-tools SecretsScan
...
### With CI/CD
- mai-security-tools integrates with GitHub Actions
