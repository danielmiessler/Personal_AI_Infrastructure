...
**Pack Dependencies:**
- **kai-history-system** (Required) - The history sync hook reads captured learnings, research, and decisions from the PAI History System and syncs them to the knowledge graph. Install this pack first.
...
**Prerequisites:**
- PAI History System (`kai-history-system`) must be installed and configured
...
if [ ! -d "$HISTORY_DIR" ]; then
    ...
    echo "   Install kai-history-system first, or skip this step."
