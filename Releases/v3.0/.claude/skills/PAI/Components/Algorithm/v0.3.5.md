...
`~/.claude/VoiceServer/pai-notify "Entering the PAI Algorithm"`

🗒️ TASK: [8 word description]

━━━ 👁️ OBSERVE ━━━ 1/7
[VERBATIM - Execute exactly as written, do not modify]
`~/.claude/VoiceServer/pai-notify "Entering the Observe phase"`
...
[VERBATIM - Execute exactly as written, do not modify]
`~/.claude/VoiceServer/pai-notify "Entering the Verify phase. This is the culmination."`
