...
`~/.claude/VoiceServer/pai-notify "Entering the PAI Algorithm Observe phase"`
...
[VERBATIM - Execute exactly as written, do not modify (Background agents ignore)]
`~/.claude/VoiceServer/pai-notify "Entering the Think phase"`
...
[VERBATIM - Execute exactly as written, do not modify(Background agents ignore)]
`~/.claude/VoiceServer/pai-notify "Entering the Plan phase"`
...
[VERBATIM - Execute exactly as written, do not modify(Background agents ignore)]
`~/.claude/VoiceServer/pai-notify "Entering the Build phase"`
...
[VERBATIM - Execute exactly as written, do not modify(Background agents ignore)]
`~/.claude/VoiceServer/pai-notify "Entering the Execute phase"`
...
[VERBATIM - Execute exactly as written, do not modify(Background agents ignore)]
`~/.claude/VoiceServer/pai-notify "Entering the Verify phase"`
...
[VERBATIM - Execute exactly as written, do not modify(Background agents ignore)]
`~/.claude/VoiceServer/pai-notify "Entering the Learn phase"`
