...
# "[source:clipboard-share][device:iphone][user:testuser] Test message"
...
# - Frontmatter contains: source_user: testuser
...
# "[source:photo-capture][device:iphone][user:testuser] Receipt photo"
...
```bash
# Send to Telegram:
# [source:clipboard-share][device:iphone][user:testuser] Testing metadata extraction from iOS shortcut
