---
name: Prompting
description: Meta-prompting system for dynamic prompt generation using templates, standards, and patterns. USE WHEN meta-prompting OR template generation OR prompt optimization OR programmatic prompt composition OR creating dynamic agents.
---

# Prompting - Meta-Prompting & Template System

> **Restored from Deprecated (2026-01-05)**
...
|----------|---------|-------------|
| N/A | Context loaded as needed | Templates and tools are used directly by other skills |

## Examples

**Example 1: Render template**
```
User: "Generate an agent briefing from this data"
-> Uses RenderTemplate.ts with Briefing.hbs
-> Outputs: Fully composed agent prompt
```

**Example 2: Meta-prompting request**
```
User: "Create a dynamic prompt for red team agents"
-> References Standards.md for best practices
-> Uses ROSTER template with agent data
-> Outputs: Data-driven agent definitions
```

## Related Skills

- **CreateSkill** - May reference Prompting standards for skill prompts
- **AgentEvaluation** - Uses Prompting templates for eval prompts
- **ContextEngineering** - Complementary skill for context optimization
