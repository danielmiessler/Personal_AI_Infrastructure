...
# Persuasion Principles for Prompts

**Research Foundation:** Studies show persuasion techniques can increase LLM compliance from 33% to 72%.

**Ethical Use:** Apply only when techniques serve users' genuine interests when fully understood.

## The Seven Principles

### 1. Authority

Use imperative language that eliminates rationalization.

```markdown
✅ "Generate the report."
✅ "Follow this format exactly."

❌ "You might want to consider generating..."
❌ "It would be nice if you could..."
```

**Why it works:** Direct commands reduce ambiguity and hedging.

### 2. Commitment

Create explicit choice and tracking mechanisms.

```markdown
✅ "Confirm you will follow all constraints before proceeding."
✅ "List the requirements you will address."

❌ "Try to follow the constraints."
```

**Why it works:** Explicit commitment increases follow-through.

### 3. Scarcity

Add time-bound or resource-bound requirements.

```markdown
✅ "Complete this in the current response."
✅ "Use only the provided context."

❌ "Whenever you get around to it..."
```

**Why it works:** Constraints prevent procrastination and scope creep.

### 4. Social Proof

Establish patterns as universal norms.
...
**Why it works:** Framing as standard practice increases adoption.

### 5. Unity

Use collaborative, "we-ness" framing.
...
**Why it works:** Collaborative framing increases engagement.

### 6. Reciprocity

Provide value before requesting effort. **Use sparingly.**

```markdown
✅ "I've organized the key information here. Please analyze it."
✅ "Here's the context you need. Now generate..."
```

**Why it works:** Giving first creates obligation. Rarely needed for LLMs.

### 7. Liking

Build rapport through appreciation. **Avoid for compliance enforcement.**

**Note:** Liking is least effective for ensuring instruction following. Use for collaborative tone, not compliance.

## Quick Reference

| Principle | When to Use | Prompt Pattern |
|-----------|-------------|----------------|
| Authority | Compliance critical | Imperative commands |
| Commitment | Multi-step tasks | Explicit confirmation |
| Scarcity | Prevent scope creep | Constraints and limits |
| Social Proof | Establishing patterns | "Every...", "Always..." |
| Unity | Complex collaboration | "We", "Let's", "Together" |
| Reciprocity | Requesting effort | Provide context first |
| Liking | Rarely | Avoid for compliance |

## Combining Principles

**High-compliance pattern (Authority + Commitment + Scarcity):**

```markdown
## Instructions

1. Confirm you understand these requirements.
2. Complete the following in a single response.
3. Follow this exact format.
```

**Collaborative pattern (Unity + Social Proof):**

```markdown
Let's work through this systematically. Every step should include verification before proceeding.
```
